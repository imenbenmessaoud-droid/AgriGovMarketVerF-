         ...
         <div className="flex flex-col md:flex-row justify-between items-center gap-4 bg-gray-50/50 p-3 rounded-2xl border border-gray-100 mb-6 relative">
             <div className="flex items-center gap-3 bg-white px-3 py-2 rounded-xl z-10 shadow-sm border border-gray-100 w-full md:w-auto flex-shrink-0">
                 ...
                 <div>
                     ...
                     <p className="text-xs font-normal text-gray-800">Various Farm Units</p>
                 </div>
             </div>
         ...
         {isExpanded && (
             <div className="mt-8 pt-6 border-t border-gray-100 animate-fadeIn">
                 ...
                 <div className="mt-8 flex items-center justify-between bg-gray-50 rounded-2xl p-4 border border-gray-100/80">
                     ...
                     <button className="px-5 py-2.5 bg-white border border-gray-200 rounded-lg text-xs font-normal text-gray-700 shadow-sm hover:bg-gray-50 transition-colors">
                         Contact Support
                     </button>
                 </div>
             </div>
        ...
        {tabs.map(tab => {
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 px-5 py-2 rounded-full text-xs font-normal transition-all whitespace-nowrap shadow-sm border border-gray-100 ${
                isActive
                  ? 'bg-black text-white'
